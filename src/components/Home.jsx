          ...
          {isMounted && (
            <>
              ...
              <p className="text-[#8892b0] py-4 max-w-[700px] animate-fadeIn delay-300">
                ...
                and functional websites. I have a strong background in web development
                and design. I am a self-motivated, hardworking, and dedicated individual
                who is always looking to learn new skills and improve my knowledge.
              </p>
